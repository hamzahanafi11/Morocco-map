 ...
 * @author pc
 */
public class BreadthFirstSearch extends AbstractGraphSearch implements Serializable {

    ArrayList<Ville> L = new ArrayList<Ville>(), T = new ArrayList<Ville>();  //L =liste des alreadyVisited  T = liste des etats but
    LinkedList<Ville> file = new LinkedList<Ville>();                         // file des sommets à explorer

    Ville[] predecessor;

    public BreadthFirstSearch(ArrayList<Ville> v) {
        this.villes = v;
    }
